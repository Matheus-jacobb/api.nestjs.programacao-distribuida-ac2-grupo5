/**
 * As mensagens padrões das validações
 */
export enum DefaultValidationMessages {
   ...
   * A mensagem padrão para o IsEmpty
   */
  IsEnum = 'Envie um valor que exista no enum.',
